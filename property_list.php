...
if (!$city) {
    echo "Sorry! We do not have any Rooms listed in this city.";
    return;
}
$city_id = $city['id'];
...
<head>
    ...
    <title>Best Rooms in <?php echo $city_name ?> | RentNow</title>
    ...
    <div class="page-container">
        ...
        <?php
            if (count($properties) > 0) {
                echo '
                <h1 style="text-align:center;">Rooms in '.$city_name.' </h1>';
            }
        ?>
